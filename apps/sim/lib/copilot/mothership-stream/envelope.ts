...
const logger = createLogger('MothershipStreamEnvelope')
...
export function isEnvelope(value: unknown): value is MothershipStreamV1EventEnvelope {
...
export function envelopeToStreamEvent(envelope: MothershipStreamV1EventEnvelope): StreamEvent {
  return {
    type: envelope.type,
